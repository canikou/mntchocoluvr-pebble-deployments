...
5. Add all runtime config files on PebbleHost:
   ...
   - Bots/famd5-5th/config/app.toml for famd5
...
- famd5 runs from Bots/famd5-5th when enabled.
...
- FAMD_DISCORD_TOKEN for FAMD-5th
